#!/usr/bin/env python3
"""council/net/_store_ledger.py — Store's ledger/economy + node/user identity methods.

Extracted from council/net/store.py (R37, step 2/4): ledger persistence, enrollment
