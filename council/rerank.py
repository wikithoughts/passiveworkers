#!/usr/bin/env python3
"""
council/rerank.py — one listwise relevance reranker for both retrieval surfaces (R36/D52)
==========================================================================================
A single local-model call scores candidate passages by relevance to a query and returns a
best-first permutation. Shared by the private-library hybrid search (``council/library.py``)
and by web-evidence selection in the researcher (``council/researcher.py``) — so the most
