#!/usr/bin/env python3
"""
passiveworkers/worker.py — A "perspective" agent
==========================================
...
the worker's OWN agent and handed in as text — wired in M4 (see passiveworkers/research.py):
passiveworkers/net/agent.py passes each node's own egress-localized search() as `web_search`
...
class PerspectiveWorker:
    ...
    # worker's own agent. passiveworkers/net/agent.py passes the node's own egress-localized
