#!/usr/bin/env python3
"""
passiveworkers/judge.py — Score, then MERGE
====================================
...
from passiveworkers.sanitize import strip_invisible
...
class Judge:
    ...
    def score(self, question: str, answers: list) -> list[ScoredCandidate]:
        """answers: list[passiveworkers.worker.Answer]. Blind, shuffled, deterministic mapping."""
