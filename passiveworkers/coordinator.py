#!/usr/bin/env python3
"""
passiveworkers/coordinator.py — the orchestrator
=========================================
...
from passiveworkers.judge import Judge, ScoredCandidate
from passiveworkers.ledger import InsufficientCredit, Ledger, Receipt
