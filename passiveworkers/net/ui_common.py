#!/usr/bin/env python3
"""
passiveworkers/net/ui_common.py — UI fragments shared by the three web surfaces
=======================================================================
The research desk (``passiveworkers.serve``), the marketplace app (``passiveworkers.net.app``), and the operator
dashboard (``passiveworkers.net.dashboard``) each embed a self-contained HTML page. A few pieces were
