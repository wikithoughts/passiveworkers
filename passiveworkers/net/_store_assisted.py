#!/usr/bin/env python3
"""passiveworkers/net/_store_assisted.py — Store's assisted (human-in-the-loop) marketplace.

Extracted from passiveworkers/net/store.py (R37, step 3/4): the D21 assisted offer lifecycle
...
from passiveworkers.net._store_base import _StoreProtocol, _clip, _now
from passiveworkers.net.config import JOB_TYPES, pool_for
...
class _AssistedMixin(_StoreProtocol):
    ...
    def deliver_assisted(self, task_id: str, node_id: str, deliverable: str,
        ...
        with self.lock:
            ...
            from passiveworkers.artifacts import read_artifact, verify_manifest
