#!/usr/bin/env python3
"""
passiveworkers/net/app.py — the Living Council Map (Phase E, map-forward)
=================================================================
...
async function refreshMe(){
  ...
  try{
    ...
    document.getElementById('contribute').textContent=
      ...
      'pworkers join '+location.origin+' <enrollment-token>    # one command · resume later with: pworkers work';
  }catch(e){}
  refreshHistory();
}
