#!/usr/bin/env python3
"""passiveworkers/net/_store_reporting.py — Store's read-only reporting methods.

Extracted from passiveworkers/net/store.py (R37, step 1/4): job status/history lookups, the
...
never instantiated on its own, only composed into passiveworkers.net.store.Store alongside
...
from passiveworkers.net._store_base import _StoreProtocol, _now
