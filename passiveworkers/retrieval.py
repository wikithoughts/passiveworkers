#!/usr/bin/env python3
"""
passiveworkers/retrieval.py — lean, local, dependency-free retrieval primitives (R8/D20)
==================================================================================
...
Anthropic-style Contextual Retrieval (see passiveworkers/library.py) it's the current SOTA that
